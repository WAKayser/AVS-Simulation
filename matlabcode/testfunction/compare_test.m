...
eventdata(1) = struct('type','cosine','delay',0.3,'duration',0.5,'amplitude', sqrt(2), 'freq',1000, 'location', 1);
eventdata(2) = struct('type','cosine','delay',0.5,'duration',1,'amplitude',sqrt(2), 'freq',5000, 'location', 1);
eventdata(3) = struct('type','pulse','delay',2,'duration',0.05,'amplitude',sqrt(2), 'freq',0, 'location', 1);
